...
const PlayerCard = ({ index, image, name, team, age, position, rating, value, club, selectedPlayer, setSelectedPlayer }) => {
    ...
    return (
        <div onClick={() => setSelectedPlayer(index)} className={cn("w-full bg-gray-800/30 rounded-md border border-gray-700 overflow-hidden shadow-lg p-0 relative hover:bg-gray-800/70 active:scale-95 cursor-pointer transition-all duration-300 delay-75", selectedPlayer === index && "border border-purple-600/50 bg-purple-500/10 hover:bg-purple-500/10")}>
            ...
            <div className="p-4 w-full flex flex-col gap-4">
                ...
                <div>
                    ...
                    <div className="flex items-center justify-between">
                        <h2 className="text-gray-300 font-semibold text-lg">{name}</h2>
                ...
                <div className="w-full flex items-center justify-between text-xs gap-2">
                    ...
                    <div className="flex flex-col">
                        ...
                        <span className="text-gray-300 text-sm font-medium">{club}</span>
                    </div>
